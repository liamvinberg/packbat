...
```
pnpm -C apps/cli typecheck && pnpm -C apps/cli test && pnpm -C apps/cloud typecheck && pnpm -C apps/cloud test && pnpm -C apps/web typecheck && pnpm -C apps/web build && pnpm check
```
